(script static void cheat_skip_intro
    ...
    (object_teleport (get_player_object_from 0) first_warthog)
    (sleep 90)
...
(script static void setup_intro_clear_sequence
    ...
    (sleep_until (volume_test_objects base_motorpool_entrance_volume (players)))
...
(script static void setup_intro_find_base
    ...
    (print "waiting for player to find first warthog")
    (sleep_until (= (is_player_in_area volume_first_warthog) true))
    ...
    (sleep_until (volume_test_objects base_tunnel_entrance_volume (players)))
)