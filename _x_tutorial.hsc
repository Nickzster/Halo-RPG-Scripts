...
(script static void hangar_tutorial_cutscene
    (player_enable_input 0)
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_control 1)
    (camera_set village_control_camera 0)
    (show_hud_help_text 1)
    (hud_set_help_text hangar_tutorial_1)
    (fade_in 0 0 0 60)
    (sleep (+ 60 60))
    (camera_set mountain_control_camera 0)
    (sleep 90)
    (fade_out 0 0 0 60)
    (sleep 60)
    (hud_set_help_text hangar_tutorial_2)
    (camera_set village_camera 0)
    (fade_in 0 0 0 60)
    (sleep (+ 60 90))
    (camera_set mountain_camera 0)
    (sleep 90)
    (fade_out 0 0 0 60)
    (sleep 60)
...
(script continuous hangar_tutorial
    ...
    (hangar_tutorial_cutscene)
    (set tutorial_hr_completed true)
    (kill_thread (get_executing_running_thread))
)

(script static void armory_tutorial_cutscene
    (player_enable_input 0)
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_control 1)
    ...
    (camera_set armory_camera 0)
    (fade_in 0 0 0 60)
    (sleep (+ 60 90))
    (fade_out 0 0 0 60)
    (object_create_anew ls_peli_crashed_1)
    (object_create_anew ls_peli_crashed_2)
    (sleep 60)
    (camera_set shotgun_camera 0)
    (fade_in 0 0 0 60)
    (hud_set_help_text armory_tutorial_2)
    (sleep (+ 60 90))
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_set rocket_camera 0)
    (fade_in 0 0 0 60)
    (sleep (+ 60 90))
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_set sniper_camera 0)
    (fade_in 0 0 0 60)
    (sleep (+ 60 90))
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_set pc_camera 0)
    (fade_in 0 0 0 60)
    (sleep (+ 60 90))
    (fade_out 0 0 0 60)
    (show_hud_help_text 0)
    (sleep 60)
    (object_destroy ls_peli_crashed_1)
    (object_destroy ls_peli_crashed_2)
    (camera_control 0)
    (player_enable_input 1)
    (fade_in 0 0 0 60)
)
...
(script static void terminal_tutorial_cutscene
    (player_enable_input 0)
    (fade_out 0 0 0 60)
    (sleep 60)
    (camera_control 1)
    (camera_set terminal_c2 0)
    (show_hud_help_text 1)
    (hud_set_help_text terminal_tutorial)
    (fade_in 0 0 0 60)
    (sleep 60)
    (camera_set terminal_c1 120)
    (sleep 120)
    (show_hud_help_text 0)
    (fade_out 0 0 0 60)
    (sleep 60)
...
(script static void tutorial_sequence
    ...
    (device_set_power skip_tutorial_light 1)
    ...
    (device_set_power skip_tutorial_light 0)
    (show_hud_help_text 1)
